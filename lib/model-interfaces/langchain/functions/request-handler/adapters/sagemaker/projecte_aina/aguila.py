...
class AguilaContentHandler(LLMContentHandler):
...
content_handler = AguilaContentHandler()


class SMAguilaAdapter(ModelAdapter):
    ...
    def get_prompt(self):
        template = """Respon a la pregunta seguent
        Nuestra conversacion actual "{chat_history}"
...
registry.register(r"(?i)sagemaker\.projecte-aina-aguila*", SMAguilaAdapter)
